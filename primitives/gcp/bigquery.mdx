...
BigQueryDatset is a primitive type that can only be managed. In general it is used as a container for your BigQueryTables.
To create a BigQueryDatset simply provide:
...
| schema             | The schema associated with the table. This can be your dataclas type that you are outputing. This is required if you are having buildflow manage your BigQuery table.                                                                                            |
