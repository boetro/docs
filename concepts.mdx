...
BuildFlow offers a [collection of dependencies](./reference/dependencies) out of the box to help you get started with common use cases. You can also [define your own dependencies](/programming-guide/dependencies/build-your-own) for your own use-cases.