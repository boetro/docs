...
<Tabs>
  <Tab title="VS Code Extension">
    <div className="grid sm:grid-cols-2 space-x-2">
      ...
      <Note>
          Once created you can copy the <code>deployment_key</code> and save it somewhere securly. You can also optionally save it securely in VSCode SecretStore locally by confirming the popup. 
      </Note>
      </div>
      <div>
      <Frame className="tailwind styles sm:hidden">
