...
BuildFlow provides many primitives out of the box, and you can also create your own custom primitives. A full list of provided primitives can be found [here](../../category/primitives/)
...
TODO fix all the links in this section
...
| source                | [SourceStrategy](TODO) | Returns an implementation of [SourceStrategy](TODO) for reading data.
| sink                  | [SinkStrategy](TODO)   | Returns an implementation of [SinkStrategy](TODO) for reading data.                       |                       |
