...
To create a custom primitive, you can implement the [Primitive](/reference/api/primitive) interface a description of all the methods is found below (bold indicates required).
