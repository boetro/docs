...
- **stack** - The name of the stack to consume, Defaults to `local`. This stack should reference a stack in your [buildflow.yaml](/programming-guide/buildflow-yaml#pulumi-configure)
