...
- [**application**](/buildflow/programming-guide/buildflow-yaml#app): the name of our application; this can be updated to any string containing lower-case letters and hyphens
