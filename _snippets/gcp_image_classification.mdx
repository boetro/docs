To run this example on resources created on GCP use [this github repo](https://github.com/launchflow/buildflow-templates/tree/main/walkthroughs/realtime-image-classification-gcp).
<Note>    
        ...
        <Steps>
                ...
                <div className="grid sm:grid-cols-2">
                    <div>
                        <ol>
                            ...
                            <li>Click `Realtime Image Classification (GCP)`</li>
                            <li>Select a directory to save the project</li>
                            <li>This will download the template and add it to your workspace</li>
                        </ol>
                        <Tip>
                            You will now see the `image-classification-gcp` app on the `Apps` tab.
                        </Tip>
                    </div>
                    <div>
                        <Frame>
                            <img style={{maxHeight: "500px", margin: 0}} alt="Create from template"src="/images/gcp-template-image-class.png"/>
                        </Frame>
                    </div>
                </div>
            </Step>
            <Step title="Install your dependencies">
                <div className="grid sm:grid-cols-2">
                    ...
                    <div>
                        <Frame>
                            ![asdf](/images/install-requirements.png)
                        </Frame>
                        <Frame>
