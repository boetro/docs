...
You can use BuildFlow to manage your infrastructure. This removes the need to have a seperate configuration management tool such as Terraform, or from managing your infrastructure manually in the cloud console.
...
<Steps>
    ...
    <Step title="Update our Infrastructure">
        If we ever change our infrastructure, for example updating a confiruration option on our bucket or topic, we can run `buildflow apply` again to have the infrastructure updated.
    </Step>
