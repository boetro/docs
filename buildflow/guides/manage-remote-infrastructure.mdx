...
You can use BuildFlow to manage your infrastructure. This removes the need to have a separate configuration management tool such as Terraform, or from managing your infrastructure manually in the cloud console.
...
<Steps>
    ...
    <Step title="Preview our Changes">
        ...
        This will output the changes that will be made to our infrastructure. In our case we will see that a new S3 bucket and GCP PubSub topic will be created.
    ...
    <Step title="Apply our Changes">
        ...
        After this step you should be able to view your infrastructure in the cloud console.
    </Step>
    <Step title="Update our Infrastructure">
        If we ever change our infrastructure, for example updating a configuration option on our bucket or topic, we can run `buildflow apply` again to have the infrastructure updated.
    </Step>
    <Step title="Destroy your Infrastructure">
        If you ever want to delete all of the infrastructure for your project, you can simply run `buildflow destroy`. Similar to apply this will preview the changes and ask you to confirm.
