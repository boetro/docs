...
The [Flow](/programming-guide/flows) class is the entrypoint into the BuildFlow Framework. They act as a container type for user-defined Processors and are responsible for orchestrating the Processors across the Runtime and Infrastructure submodules.
...
At a high-level, [Processors](/programming-guide/processors) are a user-defined function that are individually scalable. 
