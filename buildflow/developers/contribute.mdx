...
If you have an issue in mind feel free to assign it to yourself, and if you have specific questions while working on it feel free to tag [Caleb](https://github.com/boetro) or [Josh](https://github.com/JoshTanke) in a comment, or reach out directly on discord as well.
