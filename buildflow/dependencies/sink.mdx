...
For example you can depend on a [SQS](/primitives/aws/sqs) primitive or a [GCP PubSub Topc](/primitives/gcp/pubsub#gcp-pub-sub-topic) to push data to these queue.
