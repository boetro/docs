...
╭─ Options ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│ --start-runtime-server    --no-start-runtime-server             Whether to start the server for the running flow. [default: no-start-runtime-server]                   │
│ --runtime-server-host                                  TEXT     The host to use for the flow server. [default: 127.0.0.1]                                              │
│ --runtime-server-port                                  INTEGER  The port to use for the flow server. [default: 9653]                                                   │
...
│ --build-output-dir                                     TEXT     The location the build will be decompressed to. Only relevent if setting --from-build, defaults to a   │
│                                                                 temporary directory                                                                                    │
